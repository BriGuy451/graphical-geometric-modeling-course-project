...
public class MainManager : MMSingleton<MainManager>
{    
    ...
    public static PlayersManager PlayersManager {get; private set;}
    public static MissionManager MissionManager {get; private set;}
    public static GameSoundStore GameSoundStore {get; private set;}
    ...
    protected override void Awake()
    {
        ...
        GameSoundStore = GetComponent<GameSoundStore>();
    ...
    private void ChangeToStartingUI(SceneCurrent currentScene)
    {
        ...
        switch (currentScene)
        {
            case SceneCurrent.StarterTemplateMainMenuScene:
                UIManager.ChangeStateComplexView(UIComplexStates.MainMenuScreen);
    ...
    public List<IGameManager> GetStartSequence(SceneCurrent currentScene)
    {
        ...
        switch (currentScene)
        {
            case SceneCurrent.StarterTemplateStartupScene:
    ...
    private IEnumerator StartupManagers()
    {
        ...
        SceneManagerLocal.MoveToMainMenuScene(true);
    }
    ...
    {
        m_localPlayerType = playerType;
    }

    private void LogFromMethod(string message)
    {
        print($"MainManager:{message}");
    }
