Shader "6991/ExplosionVFX/Flame_02Shader"
{
    Properties
    {
        [NoScaleOffset] _FlameFlipbook ("FlameFlipbook", 2D) = "" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 fragment_shader (v2f i) : SV_Target
            {
                ...
                half4 color = tex2D(_FlameFlipbook, flipbook_uv);
